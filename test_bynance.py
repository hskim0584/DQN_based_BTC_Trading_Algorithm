...
def main():
    ...
    if TRAIN:  # Train mode
        ...
        history = pd.read_csv(
            filepath_or_buffer="./asd.csv", encoding="ms932",
            sep=",")
        scaler = StandardScaler()
        feature = ['open', 'high', 'low', 'close', 'Volume', 'Volume MA', 'RSI', 'RSI-based MA']
        scaler.fit(history[feature])
        history_df = scaler.transform(history[feature])
        state2 = [[], [], [], [], [], [], [], [], [], [], []]
        state = [[], [], [], [], [], [], [], [], [], [], []]
        Wallet = 1000
        Unit_price = 250
        ...
        stateA = []
        for i in range(50):
            state[0].append(history['open'][ i])
            state[1].append(history['high'][ i])
            state[2].append(history['low'][ i])
            state[3].append(history['close'][ i])
            state[4].append(history['Volume'][ i])
            state[5].append(history['Volume MA'][ i])
            state[6].append(history['RSI'][ i])
            state[7].append(history['RSI-based MA'][ i])
            state[8].append(Wallet)
            state[9].append(Unit_price)
            state[10].append(Leverage)
        for i in range(50):
            state2[0].append(history_df[i][0])
            state2[1].append(history_df[i][1])
            state2[2].append(history_df[i][2])
            state2[3].append(history_df[i][3])
            state2[4].append(history_df[i][4])
            state2[5].append(history_df[i][5])
            state2[6].append(history_df[i][6])
            state2[7].append(history_df[i][7])
        agent.set_newstate(state, state2)
        ...
        state[6].pop(0)
        state[7].pop(0)
        state[0].append(history['open'][ 50 ])
        state[1].append(history['high'][ 50])
        state[2].append(history['low'][ 50])
        state[3].append(history['close'][ 50 ])
        state[4].append(history['Volume'][ 50 ])
        state[5].append(history['Volume MA'][50 ])
        state[6].append(history['RSI'][50 ])
        state[7].append(history['RSI-based MA'][50 ])
        state2[0].pop(0)
        state2[1].pop(0)
        state2[2].pop(0)
        state2[3].pop(0)
        ...
        state2[6].pop(0)
        state2[7].pop(0)
        state2[0].append(history_df[50][0])
        state2[1].append(history_df[50][1])
        state2[2].append(history_df[50][2])
        state2[3].append(history_df[50][3])
        state2[4].append(history_df[50][4])
        state2[5].append(history_df[50][5])
        state2[6].append(history_df[50][6])
        state2[7].append(history_df[50][7])

        observation2 = agent.make_newstate(state, state2)
        observation2 = np.reshape(observation2, (FRAME_WIDTH, FRAME_HEIGHT, 1))
        stateA.append(observation2)
        ...
        state[6].pop(0)
        state[7].pop(0)
        state[0].append(history['open'][51])
        state[1].append(history['high'][51])
        state[2].append(history['low'][51])
        state[3].append(history['close'][51])
        state[4].append(history['Volume'][51])
        state[5].append(history['Volume MA'][51])
        state[6].append(history['RSI'][51])
        state[7].append(history['RSI-based MA'][51])
        state2[0].pop(0)
        state2[1].pop(0)
        state2[2].pop(0)
        state2[3].pop(0)
        ...
        state2[6].pop(0)
        state2[7].pop(0)
        state2[0].append(history_df[51][0])
        state2[1].append(history_df[51][1])
        state2[2].append(history_df[51][2])
        state2[3].append(history_df[51][3])
        state2[4].append(history_df[51][4])
        state2[5].append(history_df[51][5])
        state2[6].append(history_df[51][6])
        state2[7].append(history_df[51][7])
        ...
        state[6].pop(0)
        state[7].pop(0)
        state[0].append(history['open'][52])
        state[1].append(history['high'][52])
        state[2].append(history['low'][52])
        state[3].append(history['close'][52])
        state[4].append(history['Volume'][52])
        state[5].append(history['Volume MA'][52])
        state[6].append(history['RSI'][52])
        state[7].append(history['RSI-based MA'][52])
        state2[0].pop(0)
        state2[1].pop(0)
        state2[2].pop(0)
        state2[3].pop(0)
        ...
        state2[6].pop(0)
        state2[7].pop(0)
        state2[0].append(history_df[52][0])
        state2[1].append(history_df[52][1])
        state2[2].append(history_df[52][2])
        state2[3].append(history_df[52][3])
        state2[4].append(history_df[52][4])
        state2[5].append(history_df[52][5])
        state2[6].append(history_df[52][6])
        state2[7].append(history_df[52][7])
        ...
        state[6].pop(0)
        state[7].pop(0)
        state[0].append(history['open'][53])
        state[1].append(history['high'][53])
        state[2].append(history['low'][53])
        state[3].append(history['close'][53])
        state[4].append(history['Volume'][53])
        state[5].append(history['Volume MA'][53])
        state[6].append(history['RSI'][53])
        state[7].append(history['RSI-based MA'][53])
        state2[0].pop(0)
        state2[1].pop(0)
        state2[2].pop(0)
        state2[3].pop(0)
        ...
        stateA = np.swapaxes(stateA, 0, 3)
        action = agent.get_action_at_test(stateA, state)
        print('action : ', action)
        if action == 0:
            print("stay")
        elif action == 1:
            print('action = 1 : Long x5')
        elif action == 2:
            print('action = 2 : Long x10')
        elif action == 3:
            print('action = 3 : Long x25')
        elif action == 4:
            print('action = 4 : Short x5')
        elif action == 5:
            print('action = 5 : Short x10')
        elif action == 6:
            print('action = 6 : Short x25')
        elif action == 7:
            print('action = 7 : Sell All')
        elif action == 8:
            print('action = 8 : Buy more')
        elif action == 9:
            print('action = 9 : Sell once')
